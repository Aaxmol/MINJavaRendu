 ...
 * Generated at: 2022-03-10 11:37:53 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/rents/list.jsp(38,34) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/rents/list.jsp(38,34) '${listRents}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${listRents}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/rents/list.jsp(38,34) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<td> \n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<form action=\"/rentmanager/rents\" method=\"post\">\t\t\t\t\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<!-- \n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<a class=\"btn btn-primary\"\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\thref=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("/rents/details?id=2\">\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-play\"></i>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t</a> \n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t-->\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<a class=\"btn btn-success disabled\" > <i\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-edit\"></i>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t</a> \n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t \n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-danger\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${rent.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\" id=\"id\" name=\"id\" type=\"submit\"> <i\n");
