...
public class ModifieUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		getServletContext().getRequestDispatcher("/WEB-INF/views/users/modifie.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Client modifieClient=new Client(id,firstName,lastName,email,birthDatelocal);
        
        try {
        	request.setAttribute("modifieClient", this.clientService.modifie(modifieClient));
